...
c
      ...
      real x(nw),y(nh),cspln(2,nxd,nh),xc(ntmx),yc(ntmx),gsq(ntmx),
     $     dx,dy
      real psivl
      real pds(6)
      real xaxd,yaxd,psiaxd
      real xemin,xemax,yemin,yemax,yxmin,yxmax,xymin,xymax
      real dang,arcl,bperr,xmin,xmax,ymin,ymax
     ...
     $     dang,arcl,bperr,xmin,xmax,ymin,ymax
      ...
      real stfrac,delta
      parameter (jcmax=10, ihlfmx=4)
      parameter (stfrac=0.5,delta=0.1)
c........................................................................
c     local variables:
      real pi,twopi
      real thet,dthet,theta0,dthet0,dthet1,dthet2,xn,yn,rad0,rad
      real bp1,bp2,bpers,bpdiff
      integer ifail
      integer ntmx1,ier,jcount,ihalf,ipt1,ik
      real xcfn,ycfn,deli2,deln2,delfn2,delti2,deltn2
c.........................................................................
c     Initialization
c.........................................................................
      pi      = acos(-1.)
      ...
      dthet0  = dang*twopi
c.........................................................................
c     Get psi at (xaxd,yaxd) and check that (xaxd,yaxd) is inside psivl.
c.........................................................................
c      call dbcevl2(x,nw,y,nh,cspln,nxd,xaxd,yaxd,pds,ier,1)
      call bcsplint(x,y,cspln,nw,nh,nxd,xaxd,yaxd,pds,1,ier)
      psiaxd = pds(1)
      if(psiaxd .gt. psivl) then
         write(6,*)'errorin cntourp-cnt1 psiaxd=',psiaxd,psivl
!         stop
      endif
c.........................................................................
...
c.........................................................................
      thet=0.
!      write(*,*) 'first call to rayatt',nw,nh,nxd,dx,dy,xaxd,
!     $    yaxd,psiaxd,xmin,xmax,ymin,ymax,psivl,thet
!      write(*,*) 'first call to rayatt',x,nw,y,nh !cspln,nxd,dx,dy, 
!     $     xaxd,yaxd,psiaxd,xmin,xmax,ymin,ymax,psivl,thet,
!     $     xn,yn,pds,ifail
