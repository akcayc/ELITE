...
!             m=mmax-(kkfull-1)/mindex !if updownsym mindex=1
             ...
             do ij=1,19
                ...
                call splint(-psigrid,auarr(ij,jfull,kkfull,:), &
                  auspline(ij,jbig,kkbig,:), &
                  nxinterp,-psixx(i),auloc(ij))
             enddo
             do ij=7,9
                !!!!!assuming no windowing for now!!!!!!!!!!!!!!!!!
                !!!need to fix iuspline indices for windowing!!!!!
                call splint(-psigrid,iuarr(ij,jfull,kkfull,:), &
                  iuspline(ij,jbig,kkbig,:), &
                  nxinterp,-psixx(i),iuloc(ij))
             enddo
