!  numerical recipes code to calculate the hypergeometric fct
!   and replace existing hyp2f1f.c
...
!      write(*,*) 'y(1)=',y(1),'y(2)=',y(2)
      call odeint(y,4,0.d0,1.d0,EPS,.1d0,.000001d0,nok,nbad,
     * hypdrv,bsstep)
      hypgeo=y(1)
      return
      END
...
11    continue
      ...
      z=z0+s*dz
      dyds(1)=y(2)*dz
      dyds(2)=(aa*bb*y(1)-(cc-(aa+bb+1.)*z)*y(2))*dz/(z*(1.d0-z))
      return
      END
